...
<h2>(Master) 27.05.24</h2>
Надо сделать Даниилу
<ul>
  <li>Сдлеать поле поиск как в дизайне</li>
  <li>Вернуть кнопку наверх и заставить работать поиск в энциклопедии</li>
  <li>исправить отбор друзей (в последнюю очередь)</li>
  <li>Добавить динамику звёздачкам (эффект параллакса) в мега последнюю очередь</li>
</ul>
<h2>(Master) 29.05.24</h2>
<h3>КУРСАЧ ОФИЦИАЛЬНО (ПО СЛУХАМ) ГОТОВ БУЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭ</h3>
